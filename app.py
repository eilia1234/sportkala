...
def chat():
    ...
    system_prompt = {
        ...
        "content": (
            ...
            "اگر درباره شخصی اطلاعات نداری حتما بگو : (درباره آن اطلاعاتی ندارم)"
    ...
    if product:
        ...
        if any(k in msg_lower for k in keywords["price"]):
            ...
            payload_messages.append({
                "role": "system",
                "content": (
                    "اطلاعات محصول زیر برای تحلیل است. لطفاً آن را تجزیه و تحلیل کن و به شکل دوستانه و مفصل توضیح بده. "
                    "ویژگی‌ها، کاربردها، مزایا و نکات مثبت محصول را تحیل وتوضیح بده و فقط متن محصول را کپی نکن.\n\n"
